...
- **Método:** ```POST```
- **Descripción:** [Obtener el Auth token](../../rest_api/developers/authentication) necesario para realizar peticiones a otros endpoints de la API.
...
| --- | --- | --- | --- |
| [Obtener Token de Autenticación](../../rest_api/developers/authentication) | POST | ```/api/Auth/Token``` | Obtener el Auth token para realizar peticiones a otros endpoints. |
| [Listar Dispositivos](../../devices_api/rest_api/developers/get__api_devices) | GET | ```/api/devices``` | Listar dispositivos activos en la cuenta. |
| [Información de Dispositivo](../../devices_api/rest_api/developers/get__api_devices_deviceid) | GET | ```/api/devices/{deviceId}``` | Obtener información sobre un dispositivo específico. |
| [Última Ubicación](../../devices_api/rest_api/developers/get__api_devices_deviceid_lastlocation) | GET | ```/api/devices/{deviceId}/lastLocation``` | Obtener la última ubicación registrada de un dispositivo. |
| [Obtener Ubicaciones](../../devices_api/rest_api/developers/post__api_devices_deviceid_locations) | POST | ```/api/devices/{deviceId}/locations``` | Obtener ubicaciones de un dispositivo en un rango de fechas. |
| [Obtener Alertas](../../devices_api/rest_api/developers/post__api_devices_deviceid_alerts) | POST | ```/api/devices/{deviceId}/alerts``` | Obtener alertas generadas por un dispositivo en un rango de fechas. |
| [Listar Grupos](../../groups_api/rest_api/developers/get__api_groups) | GET | ```/api/groups``` | Listar todos los grupos creados en la cuenta. |
| [Crear Grupo](../../groups_api/rest_api/developers/post__api_groups) | POST | ```/api/groups``` | Crear un nuevo grupo. |
| [Obtener Información de Grupo](../../groups_api/rest_api/developers/get__api_groups_groupid) | GET | ```/api/groups/{groupId}``` | Obtener información de un grupo específico. |
| [Actualizar Grupo](../../groups_api/rest_api/developers/put__api_groups_groupid) | PUT | ```/api/groups/{groupId}``` | Actualizar información de un grupo específico. |
| [Borrar Grupo](../../groups_api/rest_api/developers/delete__api_groups_groupid) | DELETE | ```/api/groups/{groupId}``` | Borrar un grupo específico. |
| [Listar Usuarios](../../users_api/rest_api/developers/get__api_users) | GET | ```/api/users``` | Listar usuarios registrados en la cuenta. |
| [Crear Usuario](../../users_api/rest_api/developers/post__api_users) | POST | ```/api/users``` | Crear un nuevo usuario. |
| [Obtener Información de Usuario](../../users_api/rest_api/developers/get__api_users_userid) | GET | ```/api/users/{userId}``` | Obtener información de un usuario específico. |
| [Actualizar Usuario](../../users_api/rest_api/developers/put__api_users_userid) | PUT | ```/api/users/{userId}``` | Actualizar información de un usuario específico. |
| [Borrar Usuario](../../users_api/rest_api/developers/delete__api_users_userid) | DELETE | ```/api/users/{userId}``` | Borrar un usuario específico. |
| [Obtener Países](../../users_api/rest_api/developers/get__api_users_countries) | GET | ```/api/users/countries``` | Obtener la lista de países disponibles. |
| [Obtener Zonas Horarias](../../users_api/rest_api/developers/get__api_users_timezones) | GET | ```/api/users/timeZones``` | Obtener la lista de zonas horarias disponibles |
