...
---
# Registro 
El proceso de [registro](https://app.plaspy.com/SignUp) es sencillo y te permite comenzar a utilizar los servicios de seguimiento satelital de inmediato. Esta guía te explicará paso a paso cómo registrarte para iniciar tu mes gratis.

![](./registro-animated.webp "registro-animated.webp")

## Introducción

Para acceder a la página de registro, sigue estos pasos:

1. Abre tu navegador web y dirígete a la página principal de [](https://www.plaspy.com).
...
9. **Verificación de Correo**: enviará un correo electrónico de verificación a la dirección proporcionada. Revisa tu bandeja de entrada \(y la carpeta de spam, si es necesario\) y sigue las instrucciones para verificar tu cuenta.
...
- **Contraseña Segura**: La contraseña debe cumplir con los requisitos de seguridad, como longitud mínima y combinación de letras, números y caracteres especiales.
