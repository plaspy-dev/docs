...
- Los usuarios de la versión gratuita reciben alertas a través de notificaciones push en la aplicación móvil. Estas notificaciones permiten mantenerse informado sobre los eventos importantes en tiempo real.

**Historial de Seguimiento**

- La versión gratuita permite acceder al historial de seguimiento de los dispositivos hasta 5 días de antigüedad. Esto proporciona un panorama reciente de las actividades y movimientos de los dispositivos.

**Número de Dispositivos Limitado**

- Los usuarios de la versión gratuita pueden registrar un número limitado de dispositivos en su cuenta, permitiendo la gestión básica y eficiente de los mismos.
...
- **Sin chat con inteligencia artificial**: No se pueden realizar chats con AI utilizando los datos de estadísticas o el resumen de actividades.
- **Sin soporte en línea o telefónico**: La versión gratuita no incluye soporte en línea, chat en línea ni soporte telefónico.
- **Sin informes personalizados**: No es posible generar informes personalizados.
- **Sin reportes programados**: No se pueden programar reportes para ser enviados por correo electrónico.
- **Sin notificaciones por Telegram**: Las alertas no se pueden recibir a través de Telegram.
- **Sin iconos personalizados**: No se pueden subir iconos personalizados para el marcador.
- **Sin depuración avanzada de dispositivos**: La versión gratuita no permite realizar depuración avanzada de dispositivos.
- **Sin creación de subusuarios**: No es posible crear subusuarios para la cuenta.
- **Sin accesos temporales**: No se pueden crear accesos temporales para otros usuarios.
