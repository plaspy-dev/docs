...
- **¿Cómo puedo cambiar el fondo de la página de ingreso?**
...
- **¿Es obligatorio añadir un enlace a las tiendas de aplicaciones?**
 - No es obligatorio, pero es recomendable para proporcionar a los usuarios un acceso directo a las aplicaciones móviles.
- **¿Qué tipo de mensajes puedo poner en los campos de texto?**
...
- **¿Cómo puedo personalizar completamente la página de ingreso?**
...
- **¿Qué dimensiones deben tener las imágenes de fondo?**
