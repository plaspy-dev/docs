...
---
# Mapas
La sección "[*fa-globe* Mapas](https://app.plaspy.com/Settings)" en la configuración permite a los administradores integrar diversas API de mapas para proporcionar servicios de geolocalización y visualización de mapas en la plataforma. Esta funcionalidad es esencial para aplicaciones que requieren la localización precisa de dispositivos y la visualización de rutas y ubicaciones en tiempo real. En esta guía se detallan los campos disponibles y los pasos para configurarlos adecuadamente.
...
- **¿Puedo usar múltiples servicios de mapas al mismo tiempo?**
    - Sí, puedes configurar y utilizar múltiples servicios de mapas al mismo tiempo, dependiendo de tus necesidades y preferencias.
...
Con estas instrucciones, podrás configurar la sección de "Mapas" de manera efectiva y asegurar que los servicios de mapas estén integrados y funcionando correctamente en la plataforma.
