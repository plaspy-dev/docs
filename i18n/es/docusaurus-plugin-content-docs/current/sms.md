...
---
# SMS
La sección de "[SMS](https://app.plaspy.com/SMS)" permite a los usuarios gestionar y monitorear los mensajes de texto enviados por sus dispositivos. Esta funcionalidad es esencial para enviar alertas y comandos de forma eficiente y económica. Los usuarios pueden ver el historial de mensajes, agregar saldo a su cuenta y configurar límites de envío diario.
...
La plataforma permite guardar el historial de mensajes enviados en formato Excel para su análisis y almacenamiento posterior. Esta opción facilita la revisión y gestión de los mensajes enviados desde la plataforma.
...
La plataforma ofrece una página dedicada para consultar los precios de los mensajes de texto. Estos precios varían según el país y el operador. Para consultar los precios, visita [ SMS Pricing](https://app.plaspy.com/AdditionalServicesPricing). Aquí encontrarás una tabla detallada con los costos por país y operador, lo que te permitirá gestionar mejor tus gastos de mensajería.
