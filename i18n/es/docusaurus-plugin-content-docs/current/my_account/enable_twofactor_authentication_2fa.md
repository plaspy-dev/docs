...
La [Autenticación de Dos Factores](https://app.plaspy.com/UserSecurity/EnableOTP) \(2FA\) en Plaspy es una medida de seguridad adicional que ayuda a proteger tu cuenta de accesos no autorizados. Al activar 2FA, necesitarás un código de seguridad generado por una aplicación de autenticación, además de tu contraseña, para acceder a tu cuenta.

![](./image_1718291453589.gif)
...
4. **Escanear el Código QR:**
    ...
    - Plaspy te mostrará un código QR que deberás escanear con la aplicación de autenticación.
    - Si tu aplicación no soporta escanear códigos QR, puedes ingresar manualmente el código proporcionado por Plaspy.
5. **Ingresar el Código de Seguridad:**
    ...
    - Introduce este código en el campo correspondiente en Plaspy para completar el proceso de activación.
6. **Confirmación de Contraseña:**

    - Por razones de seguridad, se te pedirá que confirmes tu contraseña actual de Plaspy.
...
- **Confirmación de Contraseña:** Debes ingresar correctamente tu contraseña actual de Plaspy para finalizar la configuración de 2FA.
...
- **¿Qué es la Autenticación de Dos Factores \(2FA\)?**
    - 2FA es una medida de seguridad que requiere dos formas de verificación para acceder a tu cuenta: tu contraseña y un código de seguridad generado por una aplicación de autenticación.
- **¿Qué sucede si pierdo el acceso a mi aplicación de autenticación?**
    - En caso de perder acceso a tu aplicación de autenticación, contacta al soporte de Plaspy para asistencia en la recuperación de tu cuenta.
- **¿Puedo desactivar 2FA una vez activada?**
    - Sí, puedes desactivar 2FA desde la misma sección de configuración en tu cuenta de Plaspy. Sin embargo, no se recomienda desactivar esta capa adicional de seguridad.

Esta guía te ayudará a activar y configurar la Autenticación de Dos Factores en tu cuenta de Plaspy, mejorando la seguridad y protección de tu información.
