...
---
# Mi cuenta
En la sección "[*fa-user* Mi Cuenta](https://app.plaspy.com/Account)", puedes gestionar toda la información relevante a tu perfil y configuración personal. Esta sección está diseñada para ofrecerte un acceso fácil y rápido a tus datos, permitiéndote actualizar y gestionar tu cuenta de manera eficiente.
...
- **Nombre de Usuario:** Es el correo electrónico con el cual te registraste y donde recibes todas las notificaciones. Puedes cambiarlo desde esta sección.
