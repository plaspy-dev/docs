...
![](./dispositivosinfocertificadosanimated_20260127_094324.webp "dispositivos-info-certificados-animated.webp")

## Paso a paso para generar el certificado

1. **Selecciona el dispositivo:**  
En el [panel de dispositivos](.), elige el equipo del cual deseas obtener el certificado.
2. **Accede a la sección de Información:**  
Una vez seleccionado, aparecerá un menú con los datos principales del dispositivo y haces click en el apartado de " **Información**".
3. **Haz clic en " C** **ertificado"** **:**  
