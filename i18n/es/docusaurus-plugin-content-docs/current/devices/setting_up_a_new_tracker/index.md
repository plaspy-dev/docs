...
1. **Configurar APN**: Selecciona el país y el operador de la tarjeta SIM insertada en el rastreador. proporcionará automáticamente la configuración del APN correcta dependiendo del operador seleccionado.
...
1. **Comandos SMS**: Si tu rastreador requiere configuración mediante comandos SMS, mostrará los comandos específicos necesarios para tu dispositivo. Es importante enviar los comandos exactamente como se muestran, respetando signos, espacios, mayúsculas, minúsculas, etc.
...
1. **Agregar Dispositivo a la Cuenta**: Una vez configurado el rastreador, agrégalo a tu cuenta ingresando el IMEI o el identificador único del dispositivo en la sección de **Dispositivos**.
2. **Verificar Funcionamiento**: Asegúrate de que el dispositivo esté enviando datos correctamente y que aparezca en el mapa.

### Datos del Servidor 

Para conectar tu rastreador a, utiliza los siguientes datos del servidor:
...
Si encuentras problemas durante la configuración, contacta al soporte técnico para recibir ayuda adicional. Ellos pueden proporcionarte orientación específica y solucionar cualquier inconveniente que puedas tener.

Siguiendo estos pasos, podrás configurar tu nuevo rastreador y comenzar a utilizar sus servicios de seguimiento satelital de manera eficiente y efectiva.
