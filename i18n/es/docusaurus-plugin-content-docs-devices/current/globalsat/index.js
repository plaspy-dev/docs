export const brand = {
  ...
  "description": "Para configurar el rastreador env\u00EDe los siguientes comandos a trav\u00E9s de mensajes de texto, Formato usado por Plaspy TSPRXAB27GHKLMnaicz*U! Ingrese el n\u00FAmero de IMEI Configurar el rastreador GSS,{{imei}},3,0,D1={{apn}},D2={{apnu}},D3={{apnp}},E0=54.85.159.138,E1=8888,A1=1*{{checksum}}! Reiniciar el dispositivo GSC,{{imei}},3,0,LH*{{checksumreeboot}}! $(function () { function getCheckSum(cmd) { var checksum = 0; for (var i = 0; i input:text\u0022).val(getCheckSum($(\u0022#command\u003Estrong\u0022).text().split(\u0027*\u0027)[0])).change(); $(\u0022#reboot\u003Einput:text\u0022).val(getCheckSum($(\u0022#reboot\u003Estrong\u0022).text().split(\u0027*\u0027)[0])).change(); } var updateTimeOut; function updateCheckSum() { clearTimeout(updateTimeOut); updateTimeOut = setTimeout(_updateCheckSum, 100); } $(\u0022#imei,#apn_country,#apn_operator\u0022).change(updateCheckSum); $(\u0022#imei\u0022).keyup(updateCheckSum); });",
