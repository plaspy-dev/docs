...
description: Rastreador GPS compacto Gnxis 4-wire para vehículos y flotas compatible con Plaspy para seguimiento en tiempo real y alertas fiables
keywords:
  - Gnxis 4-wire
  - Gnxis 4 wire
  - rastreador GPS 4 cables
  - rastreador Gnxis
