...
description: Rastreador GPS GPRS para vehículos con ID de conductor RFID, memoria interna y funciones antirrobo compatible con Plaspy
keywords:
  - GOTOP VT-380A
  - VT-380A
  - rastreador GOTOP
  ...
  - gestión de flotas
  - ID de conductor RFID
  - rastreador antirrobo
  - rastreo con memoria interna
---
