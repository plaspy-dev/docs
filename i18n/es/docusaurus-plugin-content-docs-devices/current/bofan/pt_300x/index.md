...
description: Rastreador GPS compacto para vehículos con ubicación en tiempo real, alertas y compatibilidad con Plaspy para gestión de flotas
keywords:
  - bofan pt-300x
  - bofan pt 300x
  - pt-300x rastreador
  ...
  - pt-300x plaspy
  - pt-300x seguimiento de flotas
  - rastreador vehicular pt-300x
