...
description: Laipac Starfinder Datalogger es un datalogger GPS NMEA por cable, compatible con Plaspy para seguimiento en vivo y análisis posterior de puntos de ruta
keywords:
  - Laipac Starfinder Datalogger
  - Laipac Starfinder
  - Starfinder Datalogger rastreador GPS
  - datalogger NMEA
  - rastreador GNSS
  - datalogger para vehículo
