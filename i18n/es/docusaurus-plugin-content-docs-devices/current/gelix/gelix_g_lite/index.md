...
id: gelix_g_lite
sidebar_key: geligelix_g_lite_index_gelix_g_lite
sidebar_label: Gelix G Lite
title: Gelix - Gelix G Lite
sidebar_class_name: menu_item_tracker
description: Rastreador Gelix G Lite compatible con Plaspy para flotas y activos con navegación GLONASS GPS y soporte de relés y sensores
keywords:
  - Gelix G Lite
  - rastreador Gelix
  - Gelix G Lite GPS
  - Gelix compatible con Plaspy
  - Gelix G Lite seguimiento de flotas
  - rastreador GPS Gelix
  - rastreador GLONASS GPS
  - seguimiento vehicular Gelix
  - rastreador de activos Gelix
  - compatibilidad Gelix G Lite
---
