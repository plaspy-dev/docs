...
- **[*fa-building* Organization](organization):** In this tab, you can change the organization's name and platform icon. This allows Plaspy's interface to better reflect your company's identity.  

    - [***fa-mobile* Create Mobile App**:](https://app.plaspy.com/Settings/MobileApp) In this tab, you can generate a customized Plaspy mobile app for Android and iOS. You only need to fill out a short form; once you save it, Plaspy will prepare the application code with your personal branding so you can use it as your own app.
- **[*fa-user-o* Login](log_in):** Here you can customize the appearance of Plaspy's login page. You can modify the page's HTML, add custom CSS styles, and configure the background image and login page logo.
...
- **[*fa-globe* Maps](maps):** Configure Plaspy's map display options. You can choose from different map providers and set display preferences such as the default map type and information layers to display.
- **[*fa-envelope-o* Email templates](email_templates):** Allows you to customize the email templates used by Plaspy. You can modify the content and design of the emails sent from the platform, ensuring they align with your company's corporate image.
...
- **[*fa-telegram* Telegram notifications](telegram_notifications):** In this section, you can configure and customize the notifications sent via Telegram. This includes integration with Plaspy's Telegram bot and configuring automatic messages.
