...
- **Top Text**: The message that will be displayed at the top of the login page.
- **Bottom Text**: The message that will be displayed at the bottom of the login page.
...
- **Background Images**: Images that will be displayed as the background on the login page.
...
1. **Access the Section**:
    ...
    - Log in to Plaspy and go to the main menu.
    - Select "[Settings](https://app.plaspy.com/Settings)" and then "Login".
...
4. **Configure Top and Bottom Texts**:

    - Complete the "Top Text" and "Bottom Text" fields with the messages you want to appear in the respective positions on the login page.
...
6. **Upload Background Images**:
    ...
    - Click "Browse" and select the images you want to use as the background on the login page.
...
1. **How can I change the background of the login page?**
...
5. **What dimensions should the background images have?**
