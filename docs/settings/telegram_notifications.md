...
5. **Register the Bot :**
 ...
 - Click "Register" to register the bot.
 - This will allow to use your bot to send notifications via Telegram.
...
- **Can I use any Telegram bot for notifications ?**
 - Yes, you can use any Telegram bot that you have created by following the provided instructions and registering it.
...
With these instructions, you will be able to configure the "Telegram Notifications" section effectively and ensure that notifications are correctly sent via your Telegram bot on the platform.
