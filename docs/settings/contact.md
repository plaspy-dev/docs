...
---
# Contact
The "Contact" section in Plaspy's [settings](https://app.plaspy.com/Settings) allows administrators to provide contact information and configure chat services for user assistance. This section is crucial to ensure users can easily communicate with technical support or customer service. This guide details all available fields and the steps to configure them properly.

![](./image_1718312377274.gif)
...
With these instructions, you can effectively configure the "Contact" section and ensure users have multiple ways to communicate with Plaspy's technical support or customer service.
