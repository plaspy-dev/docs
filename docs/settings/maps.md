...
- **Can I use multiple map services at the same time?**
    - Yes, you can configure and use multiple map services at the same time in Plaspy, depending on your needs and preferences.
...
With these instructions, you will be able to configure the "Maps" section effectively and ensure that the map services are integrated and functioning correctly on the Plaspy platform.
