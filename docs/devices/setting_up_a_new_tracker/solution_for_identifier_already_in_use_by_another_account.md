...
If you receive a message indicating that the identifier or serial number is already in use by another account when trying to add your device to your Plaspy account, you can follow these steps to resolve the issue.
...
If you encounter any problems during the reconfiguration process or when adding the device to your account, do not hesitate to contact Plaspy technical support. We are here to help you regain control of your devices and resolve any issues.
