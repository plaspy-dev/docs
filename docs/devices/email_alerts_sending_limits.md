...
- **What happens if I exceed the sending limits?**
    - If you exceed the email alert sending limits, you will not be able to send new messages until the restricted time period has passed. However, you will still have access to your account and can receive alerts through the map on Plaspy.
- **Can I change the sending limits?**
    - No, the sending limits are not configurable by users. They are set by Plaspy to ensure the proper functioning of the system and the security of accounts.
