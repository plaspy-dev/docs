...
- **IMEI or Identifier**: The IMEI \(International Mobile Equipment Identity\) or unique identifier of the device is crucial for its correct configuration and communication with the system. This code usually has 15 digits, although some trackers use the last 11.
...
1. Download and install the [ mobile](../mobile_application) app from your mobile device's app store.
