...
![](./certificates-animated.webp "certificates-animated.webp")
...
2. **Access the Information section:** Once selected, a menu will appear with the device's main data. Click on the " **Information**" tab.
3. **Click on " Certificate":** You will find this button at the bottom left of the menu. Simply click there.
