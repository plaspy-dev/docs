...
---
# Reminders
The Reminders section in Plaspy allows users to schedule [alerts](alerts) for important events related to their tracking [devices](.). These alerts can be based on specific dates or the vehicle's mileage, and are sent via email to ensure that critical tasks, such as vehicle maintenance, are not forgotten.

![](./image_1718310269027.gif)
