...
| --- | --- | --- | --- |
| [Get Authentication Token](../../rest_api/developers/authentication) | POST | ```/api/Auth/Token``` | Obtain the Auth token to make requests to other endpoints. |
| [List Devices](../../devices_api/rest_api/developers/get__api_devices) | GET | ```/api/devices``` | List active devices in the account. |
| [Device Information](../../devices_api/rest_api/developers/get__api_devices_deviceid) | GET | ```/api/devices/{deviceId}``` | Get information about a specific device. |
| [Last Location](../../devices_api/rest_api/developers/get__api_devices_deviceid_lastlocation) | GET | ```/api/devices/{deviceId}/lastLocation``` | Get the last recorded location of a device. |
| [Get Locations](../../devices_api/rest_api/developers/post__api_devices_deviceid_locations) | POST | ```/api/devices/{deviceId}/locations``` | Get locations of a device within a date range. |
| [Get Alerts](../../devices_api/rest_api/developers/post__api_devices_deviceid_alerts) | POST | ```/api/devices/{deviceId}/alerts``` | Get alerts generated by a device within a date range. |
| [List Groups](../../groups_api/rest_api/developers/get__api_groups) | GET | ```/api/groups``` | List all groups created in the account. |
| [Create Group](../../groups_api/rest_api/developers/post__api_groups) | POST | ```/api/groups``` | Create a new group. |
| [Group Information](../../groups_api/rest_api/developers/get__api_groups_groupid) | GET | ```/api/groups/{groupId}``` | Get information about a specific group. |
| [Update Group](../../groups_api/rest_api/developers/put__api_groups_groupid) | PUT | ```/api/groups/{groupId}``` | Update information about a specific group. |
| [Delete Group](../../groups_api/rest_api/developers/delete__api_groups_groupid) | DELETE | ```/api/groups/{groupId}``` | Delete a specific group. |
| [List Users](../../users_api/rest_api/developers/get__api_users) | GET | ```/api/users``` | List users registered in the account. |
| [Create User](../../users_api/rest_api/developers/post__api_users) | POST | ```/api/users``` | Create a new user. |
| [User Information](../../users_api/rest_api/developers/get__api_users_userid) | GET | ```/api/users/{userId}``` | Get information about a specific user. |
| [Update User](../../users_api/rest_api/developers/put__api_users_userid) | PUT | ```/api/users/{userId}``` | Update information about a specific user. |
| [Delete User](../../users_api/rest_api/developers/delete__api_users_userid) | DELETE | ```/api/users/{userId}``` | Delete a specific user. |
| [Get Countries](../../users_api/rest_api/developers/get__api_users_countries) | GET | ```/api/users/countries``` | Get the list of available countries. |
| [Get Time Zones](../../users_api/rest_api/developers/get__api_users_timezones) | GET | ```/api/users/timeZones``` | Get the list of available time zones. |
