...
- **What happens if I lose access to my authentication app?** If you lose access to your authentication app, contact Plaspy support for assistance in recovering your account.
- **Can I disable 2FA once it is activated?** Yes, you can disable 2FA from the same settings section in your Plaspy account. However, it is not recommended to disable this additional layer of security.
