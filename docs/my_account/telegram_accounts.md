...
---
# Telegram Accounts
The platform allows users to receive notifications via [Telegram](https://app.plaspy.com/Telegram?from=/Account), making it easy to stay updated with important events in real-time. Below are the steps to configure this option:

![](./image_1718311352083.gif)

### Field Descriptions

- **Telegram Bot:** @PlaspyBot is the bot that will allow you to receive notifications on your Telegram account.
- **Log in with Telegram:** Button that redirects to Telegram authentication to link your account.
...
- **Authentication:** You must have an active Telegram account to link it and receive notifications.
