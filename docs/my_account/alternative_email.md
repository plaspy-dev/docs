...
---
# Alternative Email
Using an [alternative email](https://app.plaspy.com/UserSecurity/Email2?from=/Account) in Plaspy is an additional security measure that allows you to recover your account if you cannot access your primary email. Below are the steps to configure and use this functionality.

![](./image_1718311463462.gif)
...
- **Can I change my alternative email later?**
    - Yes, you can change your alternative email at any time by accessing your account settings in Plaspy.
...
This guide will help you set up and manage your alternative email in Plaspy, providing an additional security measure to protect your account.
