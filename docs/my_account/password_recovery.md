...
---
# Password Recovery
In Plaspy, the "[Password Recovery](https://app.plaspy.com/Forgot/Password)" functionality allows users to reset their password in case it is forgotten. This guide will walk you through the steps necessary to regain access to your account securely and efficiently.

![](./image_1718311877767.gif)
...
- **Email for login**: Enter the email address associated with your Plaspy account.
- **I'm not a robot**: Check the box to complete the reCAPTCHA, confirming you are not a robot.

### Step-by-Step Instructions

1. **Enter Email**: In the "Email for login" field, enter the email address you used to register your Plaspy account.
...
4. **Email Verification**: Plaspy will send an email to the provided address. Check your inbox \(and spam folder, if necessary\) for the password recovery email. This email will contain a 6-digit verification code.
5. **Enter Verification Code**: Once you receive the email, open the message and locate the 6-digit verification code. Enter this code on the Plaspy page where requested to continue the password reset process.
...
8. **Confirm Changes**: Click the button to confirm the changes. You can now log in to your Plaspy account using your new password.

### Validations and Restrictions

- **Registered Email**: Ensure you enter the email address registered with your Plaspy account. Otherwise, you will not receive the recovery email.
...
- **Password Security**: The new password must meet Plaspy's security requirements, such as minimum length and a combination of letters, numbers, and special characters.
...
- **What should I do if I do not receive the password recovery email?**
    ...
    - Ensure the email address entered is correctly registered with your Plaspy account.
...
By following these steps, you can reset your password securely and quickly, ensuring your Plaspy account remains accessible and protected.
