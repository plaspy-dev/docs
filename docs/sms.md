...
---
# SMS
The "[*fa-envelope-o* SMS](https://app.plaspy.com/SMS)" section allows users to manage and monitor text messages sent by their devices. This functionality is essential for sending alerts and commands efficiently and cost-effectively. Users can view message history, add balance to their account, and set daily sending limits.
...
To send a text message from, follow these steps:
...
The platform allows saving the history of sent messages in Excel format for further analysis and storage. This option facilitates the review and management of messages sent from the platform.
...
### Checking Text Message Prices
 ...
 offers a dedicated page to check the prices of text messages. These prices vary by country and operator. To check the prices, visit [ SMS Pricing](https://app.plaspy.com/SMSPricing). Here you will find a detailed table with costs by country and operator, allowing you to better manage your messaging expenses.
...
6. **Check Text Message Prices:**
 - Visit [ SMS Pricing](https://app.plaspy.com/AdditionalServicesPricing) to review prices by country and operator.
...
- **Where can I check the prices of text messages?**
 - You can check the prices of text messages by country and operator on the [ SMS Pricing](https://app.plaspy.com/SMSPricing) page.
