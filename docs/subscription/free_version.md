...
- Free version users receive alerts through push notifications on the mobile app. These notifications keep users informed about important events in real-time.

**Tracking History**

- The free version allows access to device tracking history up to 5 days old. This provides a recent overview of the activities and movements of the devices.

**Limited Number of Devices**

- Free version users can register a limited number of devices on their account, allowing for basic and efficient management.
...
- **No AI Chat**: Chatting with AI using statistics data or activity summaries is not possible.
- **No Online or Phone Support**: The free version does not include online support, live chat, or phone support.
- **No Custom Reports**: Generating custom reports is not possible.
- **No Scheduled Reports**: Scheduled reports cannot be sent via email.
- **No Telegram Alerts**: Alerts cannot be received via Telegram.
- **No Custom Icons**: Custom icons for markers cannot be uploaded.
- **No Advanced Device Debugging**: Advanced device debugging is not allowed.
- **No Subuser Creation**: Creating subusers for the account is not possible.
- **No Temporary Access Creation**: Temporary access for other users cannot be created.
- **No Custom Logo Upload**: Users cannot upload a custom logo for their account.
- **No Excel Downloads**: Statistics cannot be downloaded in Excel format, nor can batch statistics for all devices be downloaded.
