export const brand = {
  ...
  "description": "To set the tracker send the following commands by SMS messages, the ID is the last 6 numbers of IMEI excluding the last number. for example, if the IMEI is 12345678 901234 5 the device Id is 901234 Type the IMEI number 13\u0022\u003E Your Plaspy device ID is {{imei.substring(8,14)}} Set the operator APN and GPRS server SA200NTW;{{(\u0027XXXXXX\u0027 \u002B imei.substring(8,14)).slice(-6)}};02; 1 0 ;{{apn}};{{apnu}};{{apnp}};54.85.159.138;8888;;;; Set the update interval to 60 seconds SA200RPT;{{(\u0027XXXXXX\u0027 \u002B imei.substring(8,14)).slice(-6)}};02;60;60;60;3;0;0;0;0;0 To check settings SA200CMD;{{(\u0027XXXXXX\u0027 \u002B imei.substring(8,14)).slice(-6)}};02;PresetA",
