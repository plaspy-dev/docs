...
description: Compact GPS data logger that records second by second locations and NMEA logs and works with Plaspy for fleet and asset tracking
keywords:
  - ArkNav K-18U
  - K-18U GPS data logger
  - ArkNav GPS logger
  - K-18U Plaspy compatible
  - GPS NMEA logging
  - fleet tracking logger
  - asset tracking device
  - K-18S tracking software
  - micro SD GPS logger
  - journey recorder
---
