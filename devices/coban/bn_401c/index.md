...
description: Compact Coban BN 401C GPS tracker for motorcycles and small vehicles compatible with Plaspy for real time tracking and basic remote immobilization
keywords:
  - Coban BN-401C
  - BN-401C
  - Coban tracker
  ...
  - vehicle tracker compact
  - anti theft tracker
  - relay fuel cutoff
  - GSM GPS tracker
  - fleet tracking motorcycle
---
