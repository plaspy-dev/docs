...
description: Compact Telic SBC AVL telematics unit for fleet tracking and driver detection compatible with Plaspy for real time location and vehicle level insights
keywords:
  - Telic SBC AVL
  - SBC AVL tracker
  - Telic tracker
